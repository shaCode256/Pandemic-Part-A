...
TEST_CASE("Checking the demo works as expected")
{
    ...
    CHECK_EQ(board[City::Kinshasa], 3); // put 3 yellow disease cubes in Kinshasa.

    board[City::Kinshasa] = 2;          // change number of disease cubes in Kinshasa to 2.
    CHECK_EQ(board[City::Kinshasa], 2); // change number of disease cubes in Kinshasa to 2.

    board[City::MexicoCity] = 3;          // put 3 yellow disease cubes in MexicoCity
    CHECK_EQ(board[City::MexicoCity], 3); // put 3 yellow disease cubes in MexicoCity

    board[City::HoChiMinhCity] = 1;          // put 1 red disease cube in HoChiMinhCity
    CHECK_EQ(board[City::HoChiMinhCity], 1); // put 1 red disease cube in HoChiMinhCity

    board[City::Chicago] = 1;          // put 1 blue disease cube in Chicago
    CHECK_EQ(board[City::Chicago], 1); // put 1 blue disease cube in Chicago
    ...
    CHECK_EQ(board.is_clean(), 1); // << endl;  // prints "1" - the board is clean - congratulations!!! You treated all diseases!!!
}